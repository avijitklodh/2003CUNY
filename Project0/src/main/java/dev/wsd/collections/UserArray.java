...
public class UserArray<T> implements Iterable<T> {
    ...
    class ArrayIterator implements Iterator<T> {
        ...
        public boolean hasNext() {
            if (current < UserArray.this.values.length) {
                return true;
            } else {
                return false;
            }
    ...
    public static void main(String[] args) {
        ...
        UserArray<String> array = new UserArray<String>(strings);
