...
public class Box {
	...
	// every box you create has its own value variable
	int value;
	
	
	// class or static scope
	// this variable belongs to the class itself not to any instance of the class. no box is particular
	// there will only ever be one of this shareValue
