...
public class ArrayFactory {
	...
	// Design patterns are common software conventions for solving recurring problems in development
	// Factory is designed to return you an implementation of a an interface or a sub class of a generic class
